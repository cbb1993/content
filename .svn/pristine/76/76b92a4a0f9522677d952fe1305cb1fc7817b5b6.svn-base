 ...
 */
public class NRecyclerView extends PullToRefreshBase<WrapRecyclerView>
{
    ...
    public NRecyclerView(Context context, Mode mode)
    {
        super(context, mode);
    }

    public NRecyclerView(Context context, Mode mode, AnimationStyle style)
    {
    ...
    protected WrapRecyclerView createRefreshableView(Context context, AttributeSet attrs)
    {
        ...
        recyclerView.setId(com.kevin.ultimaterecyclerview.R.id.ultimate_recycler_view);
        return recyclerView;
    }
    ...
    private void init(Context context, AttributeSet attrs)
    {
        ...
        // Styleables from XML
        TypedArray ua = context.obtainStyledAttributes(attrs, com.kevin.ultimaterecyclerview.R.styleable.UltimateRecyclerView);
        mURecyclerViewExtrasEnabled = ua.getBoolean(com.kevin.ultimaterecyclerview.R.styleable.UltimateRecyclerView_ptrURecyclerViewExtrasEnabled, true);
        ua.recycle();
    ...
    protected class InternalWrapRecyclerView extends WrapRecyclerView
    {
         ...
         * @Author zhou.wenkai
         */
        private synchronized boolean isLastItemVisible()
        {
            final RecyclerView.Adapter<?> adapter = getRefreshableView().getAdapter();
            ...
            } else
            {
                ...
                if (lastVisiblePosition == mRefreshableView.getAdapter().getItemCount() - 2)
                {
                    ...
                    if (lastVisiblePosition > mTmplastVisiblePosition)
                    {
